...
import SearchResults from "./componets/SearchedItems";
		...
		<main>
			...
			{submitted === true ? (
				CartScroll || WishlistScroll || CheckoutScroll ? (
					<>
						<button
							className="close--button end--search--button"
							onClick={() => setSubmitted(false)}
						>
							End search
							<span className="material-symbols-rounded">close</span>
						</button>
						<div className="product--grid">{searchGrid}</div>
					</>
				) : (
				...
				<>
					<Banner />
					<section className="product--grid">{productGrid}</section>
				</>
			) : (
				<div className="overlay"></div>
			)}
